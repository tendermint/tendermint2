...
```bash
go test -v --bench github.com/tendermint/tendermint2/pkgs/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/tendermint/tendermint2/pkgs/crypto/keys/mintkey
...
PASS
ok  	github.com/tendermint/tendermint2/pkgs/crypto/keys/mintkey	12.093s
```
