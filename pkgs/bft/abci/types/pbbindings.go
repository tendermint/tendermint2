...
func IsResponseInfoReprEmpty(goor ResponseInfo) (empty bool) {
	{
		...
		{
			if goor.LastBlockHeight != int64(0) {
				return false
			}
		}
		{
...
func IsBlockParamsReprEmpty(goor BlockParams) (empty bool) {
	{
		empty = true
		{
			if goor.MaxTxBytes != int64(0) {
				return false
			}
		}
		{
			if goor.MaxDataBytes != int64(0) {
				return false
			}
		}
		{
			if goor.MaxBlockBytes != int64(0) {
				return false
			}
		}
		{
			if goor.MaxGas != int64(0) {
				return false
			}
		}
		{
			if goor.TimeIotaMS != int64(0) {
				return false
			}
		}
	}
...
func IsVoteInfoReprEmpty(goor VoteInfo) (empty bool) {
	{
		...
		{
			if goor.SignedLastBlock != bool(false) {
				return false
			}
		}
	}
