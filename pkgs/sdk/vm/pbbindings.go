...
func Ism_callReprEmpty(goor MsgCall) (empty bool) {
	{
		empty = true
		{
			goor, err := goor.Caller.MarshalAmino()
			if err != nil {
				return false
			}
			if goor != string("") {
		...
		{
			goor, err := goor.Send.MarshalAmino()
			if err != nil {
				return false
			}
			if goor != string("") {
...
func Ism_addpkgReprEmpty(goor MsgAddPackage) (empty bool) {
	{
		empty = true
		{
			goor, err := goor.Creator.MarshalAmino()
			if err != nil {
				return false
			}
			if goor != string("") {
		...
		{
			goor, err := goor.Deposit.MarshalAmino()
			if err != nil {
				return false
			}
			if goor != string("") {
